...
public class ApiControllerVentas {
	...
	@GetMapping(value = "/ventasCliente/{cedula}", produces = MediaType.APPLICATION_JSON_VALUE)
	
	public ResponseEntity<Object> ventaCliente (@PathVariable int cedula){
		return ResponseEntity.ok(this.ventaService.ventasCliente(cedula));
	}*/
}
